...
use IngressITSolutions\Packagist\Facades\Packagist;
...
class PackagistServiceProviderTest extends LaravelTestCase
{
    ...
    public function it_registers_a_facade()
    {
        $this->app->bind(PackagistClient::class, function () {
            ...
            $client->expects($this->once())
                ...
                ->with('ingress-it-solutions/laravel-packagist')
        ...
        $result = Packagist::getPackageMetadata('ingress-it-solutions/laravel-packagist');
    ...
    public function it_can_override_the_url_configuration()
    {
        ...
        $config->set('services.packagist', [
            'base_url' => 'https://www.ingressit.com',
        ...
        $this->assertEquals('https://www.ingressit.com/test.json', $apiResult);
